...
def test_calculate_business_metrics(sample_predictions):
...
def test_calculate_pr_auc(sample_predictions):
...
def test_optimize_threshold(sample_predictions):
...
def test_threshold_optimization_consistency():
